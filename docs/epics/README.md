...
| [15](epic-15-journal-des-sorties.md) | **Journal des sorties** | Voir les dernières sorties de quelqu'un depuis le classement, pour s'en inspirer | S | **avant le 1ᵉʳ octobre** |

> **Ces quatre epics ne sont pas sur le chemin critique**, et c'est ce qui les rend sûrs :
...
>
> **L'epic 14 est le seul des quatre qui soit un levier de recrutement.** Il répond à un
...
>
> **L'epic 15 est le seul des quatre qui touche à des données personnelles sensibles.** Il
> montre les sorties d'un participant aux autres : ce qui est privé sur Strava y reste
> privé, le titre n'est jamais rendu, et chacun peut couper l'affichage sans rien perdre
> de son classement.
>
